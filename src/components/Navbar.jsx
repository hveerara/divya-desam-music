    ...
    <header className="bg-[#a16207] sticky top-0 z-10 w-full font-poppins">
      <div className="container mx-auto flex flex-wrap p-3 flex-col md:flex-row sm:flex-row xs:flex-row justify-center items-center">
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	flex flex-wrap break-words items-center text-base justify-center">
          <Link
            to="/about"
            className="ml-2 mr-4 text-xl title-font  text-white"
          >
            Veeraragavathatham
          </Link>
          ...
          <Link to="/chozhaNaadu" className="mr-3 hover:text-white">
            Chozha Naadu
          </Link>
          <Link to="/naduNaadu" className="mr-3 hover:text-white">
            Nadu Naadu
          </Link>
          <Link to="/thondaiNaadu" className="mr-3 hover:text-white">
            Thondai Naadu
          </Link>
          <Link to="/malaiNaadu" className="mr-3 hover:text-white">
            Malai Naadu
          </Link>
